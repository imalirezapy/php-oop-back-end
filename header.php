...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
        ...
        <ul class="navbar-nav">
            ...
            <?php if (! $important->login()){ ?>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="../templates/login.php" class="nav-link">ورود/ثبت نام</a>
                </li>
            <?php } else {?>
                <li class="nav-item d-none d-sm-inline-block">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        <?= $food['name']?>
                                        <span class="float-left text-sm text-muted"><i class="font-italic"><?= number_format($food['price'] * $food['count'])?> تومان</i></span><br>
